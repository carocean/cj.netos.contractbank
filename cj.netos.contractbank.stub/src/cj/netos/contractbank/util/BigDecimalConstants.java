...
public interface BigDecimalConstants {
	...
	static String default_sellCashDepositRate = "0.16";// 默认委托卖单保证金率
	static String default_buyCashDepositRate = "0.16";// 默认委托买单保证金率
	 ...
	 * @return
	 */
	default BigDecimal defaultSellCashDepositRate(ICBankPropertiesBS cbankPropertiesBS, String bank) {
		String strdefault_putonCashDepositRate = cbankPropertiesBS.get(bank,
				CBankProperty.CONSTANS_KEY_default_sellCashDepositRate);
		if (StringUtil.isEmpty(strdefault_putonCashDepositRate)) {
			strdefault_putonCashDepositRate = default_sellCashDepositRate + "";
		}
		return new BigDecimal(strdefault_putonCashDepositRate).setScale(scale, roundingMode);
	}
	/**
	 ...
	 * @return
	 */
	default BigDecimal defaultBuyCashDepositRate(ICBankPropertiesBS cbankPropertiesBS, String bank) {
		String strdefault_putonCashDepositRate = cbankPropertiesBS.get(bank,
				CBankProperty.CONSTANS_KEY_default_buyCashDepositRate);
		if (StringUtil.isEmpty(strdefault_putonCashDepositRate)) {
			strdefault_putonCashDepositRate = default_buyCashDepositRate + "";
		}
		return new BigDecimal(strdefault_putonCashDepositRate).setScale(scale, roundingMode);
	}
	/**
