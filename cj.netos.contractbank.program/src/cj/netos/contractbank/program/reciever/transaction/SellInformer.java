...
@CjService(name = "/reciever/transaction/sell.service")
public class SellInformer implements IGatewayAppSiteWayWebView {
	...
	public void flow(Frame frame, Circuit circuit, IGatewayAppSiteResource resource) throws CircuitException {
		frame.content().accept(new MemoryContentReciever() {
			...
			public void done(byte[] b, int pos, int length) throws CircuitException {
				...
				cbankSellOrderBS.complateOrder(bankno,orderno,response);
			}
		});
